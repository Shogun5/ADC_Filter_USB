...
# Date: Mon, 22 Jan 2018 03:22:33 GMT
#set_units -time ns
...
create_generated_clock -name {timer_clock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 12001 24001} [list [get_pins {ClockBlock/dclk_glb_2}]]
create_clock -name {timer_clock(fixed-function)} -period 500000 -waveform {0 41.6666666666667} [get_pins {ClockBlock/dclk_glb_ff_2}]
...
# Project: D:\Shogun Files\PSoC_project\CE95277 ADC and UART\ADC_Filter_USB.cydsn\ADC_Filter_USB.cyprj
# Date: Mon, 22 Jan 2018 03:22:24 GMT
