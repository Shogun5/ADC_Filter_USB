...
module UART_v2_50_1 (
	...
	cy_clock_v1_0
		#(.id("fcd4d153-7892-4cd3-8efc-197908013968/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
...
module CharLCD_v2_20_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("085b5c7f-5f03-4528-896c-971ecf1b57c9/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
    ...
    defparam GlitchFilter.GlitchLength = 50;
    defparam GlitchFilter.SignalWidth = 1;


	cy_clock_v1_0
		#(.id("2a08140e-9af9-47cd-91f5-e9690d7b0b01"),
